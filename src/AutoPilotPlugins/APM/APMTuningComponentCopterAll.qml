...
Item {
    ...
    property var pages:  [
        "APMTuningComponentCopterRate.qml",
        "APMTuningComponentCopterAttitude.qml",
        "APMTuningComponentCopterVelocity.qml",
        "APMTuningComponentCopterPosition.qml"
    ]
